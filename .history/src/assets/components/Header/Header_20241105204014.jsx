...
function Header() {
  ...
  return (
    <header className="fixed lg:static bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded border-gray-300 font-sans border z-50 w-">
      <div className="container mx-auto flex justify-between items-center md:p-2 py-2 px-full ">
        ...
        {/* Desktop Nav */}
        <nav className="hidden md:hidden md:flex space-x-20 text-xl">
