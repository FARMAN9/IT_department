...
function DepartmentOfItInfo() {
  ...
  return (
    <div className="w-auto mx-auto mt-3 bg-white rounded-lg shadow-lg overflow-hidden">
      {/* Card Image */}
      <img
      ...
      <div className="p-4">
        ...
        <p className="text-gray-600 mt-2">
          ...
          distinctio. Labore sapiente natus libero. Lorem ipsum dolor sit, amet
          consectetur adipisicing elit. Doloremque pariatur error ducimus
