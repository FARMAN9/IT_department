...
function DepartmentOfItInfo() {
  return (
    <div className="mx-auto h-full mt-3 bg-white rounded-lg shadow-lg shadow-blue-200 ">
      {/* Card Image */}
      <img
        ...
        className="w-full h-[380px] rounded-lg shadow shadow-blue-200 "
      />

      {/* Card Content */}
      <div className="p-4">
        <h2
          className="text-4xl font-semibold bg-clip-text text-transparent text-center rounded-lg shadow-2xl shadow-orange-950"
          style={{
        ...
        <div className="text-gray-600 mt-3  overflow-y-auto">
          <p>
