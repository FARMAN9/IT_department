...
const PlacementSlider = () => {
  ...
  return (
    <div className="border shadow-md rounded-md shadow-blue-200py-8 sm:py-14">
      <div className="flex-col mx-auto px-4 ">
        ...
        <div className="relative ">
          ...
          {/* Placement Cards */}
          <div className="overflow-hidden  w-[330px]  h-100 md:w-full lg:w-full ">
            <div
            ...
            <div className="flex justify-center mt-6">
              <p className="text-sm sm:text-base text-gray-600">
                {currentIndex + 1} of {placementData.length - (cardsToShow - 1)}
              </p>
            </div>
          </div>
