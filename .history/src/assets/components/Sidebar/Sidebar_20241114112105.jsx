  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-6 right-1 z-50 p-2  bg-blue-500 rounded-md shadow-md  text-white mt-6 ">
        {isMobileOpen ? (
          <X className="w-6 h-6" />
        ) : (
      ...
      <div
        className={`
        fixed lg:static  right-100  z-40 rounded-md shadow-md shadow-inner p-0 mt-24 md:mt-0  text-white rounded 
        transform ${
