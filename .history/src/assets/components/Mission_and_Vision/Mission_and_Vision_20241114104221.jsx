...
function MissionAndVision() {
  ...
  return (
    <div className="max-w-4xl mx-automt-3 bg-white rounded-lg shadow-lg overflow-hidden">
      {/* Video Section */}
      <div className="w-full mb-6">
        <iframe
          className="w-full h-64 sm:h-96 rounded-xl shadow-lg"
          src="https://www.youtube.com/watch?v=gPfEJLt4nCc" // Replace with your YouTube video link
