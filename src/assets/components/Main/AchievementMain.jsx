  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <AchievementCard 
          icon={
            <FileText className="w-12 h-12 text-teal-600" strokeWidth={1.5} />
          }
          title="Publications"
          value="160"
        />
        ...
        <AchievementCard 
          icon={
            <Award className="w-12 h-12 text-teal-600" strokeWidth={1.5} />
          }
          title="Patents"
          value="10"
        />
        ...
        <AchievementCard 
          icon={
            <Quote className="w-12 h-12 text-teal-600" strokeWidth={1.5} />
          }
          title="Citations"
          value="10000+"
        />
        ...
        <AchievementCard 
          icon={
            <Users className="w-12 h-12 text-teal-600" strokeWidth={1.5} />
          }
        ...
        <AchievementCard 
          icon={
            <MapPin className="w-12 h-12 text-teal-600" strokeWidth={1.5} />
          }
          title="Placements"
          value="98.3%"
        />
        ...
        <AchievementCard 
          icon={
            <Trophy className="w-12 h-12 text-teal-600" strokeWidth={1.5} />
          }
