...
function DepartmentOfItInfo() {
  return (
    <div className="mx-auto h-full mt-3 bg-white rounded-lg shadow-lg shadow-blue-200 overflow-hidden">
      {/* Card Image */}
      <img
        ...
        className="w-full h-[380px] rounded-lg shadow shadow-blue-200 overflow-hidden"
      />
