  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-10">
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          <img src="path/to/logo.png" alt="NITJ Logo" className="w-16 mb-4" />
          ...
          {/* Social Media Links */}
          <div className="flex mt-4 space-x-4 self-baseline">
        ...
        {/* Quick Links Section */}
        <div className="hidden md:col-span-2 grid grid-cols-2 gap-4">
          <div>
      ...
      <div className="mt-8 border-t border-gray-700 pt-4">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-sm">
          <p>&copy; Copyright 2023, All Rights Reserved NIT Jalandhar</p>
          <p>
