const Card = () => {
  ...
  return (
    <div className="max-w-3xl rounded-lg border border-gray-200 bg-white shadow-sm">
      <div className="p-6">
        <div className="mb-6">
          <div className="inline-block bg-cyan-700 text-white px-6 py-2 rounded-2xl text-lg font-semibold">
            News & Highlights
          </div>
        </div>
