      ...
      <div className="container mx-auto px-4">
        ...
        <div className="space-y-4 pb-12">
          ...
          <p className="text-center sm:px-44">
            See our students' amazing achievements.
          </p>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <button
            onClick={prevSlide}
            className="absolute md:left-0 left-8 top-1/2 -translate-y-1/2 -translate-x-12 p-2 rounded-full bg-blue-200 dark:bg-blue-800 hover:bg-blue-300 dark:hover:bg-blue-700 transition-colors z-10"
          ...
          <button
            onClick={nextSlide}
            className="absolute md:right-0 right-8 top-1/2 -translate-y-1/2 translate-x-12 p-2 rounded-full bg-blue-200 dark:bg-blue-800 hover:bg-blue-300 dark:hover:bg-blue-700 transition-colors z-10"
