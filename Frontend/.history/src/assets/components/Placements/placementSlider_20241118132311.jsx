...
const PlacementSlider = () => {
  ...
  return (
    <div className="border shadow-md rounded-md shadow-blue-200 md:flex text-gray-900 py-14 block">
      <div className="container mx-auto px-4 ">
        ...
        <div className="relative max-w-full mx-auto ">
          ...
          <button
            onClick={prevSlide}
            className="absolute md:left-8 left-8 top-1/2 -translate-y-1/2 -translate-x-12 p-2 rounded-full bg-blue-200 hover:bg-blue-300 transition-colors z-10"
          ...
          <button
            onClick={nextSlide}
            className="absolute md:right-8 right-8 top-1/2 -translate-y-1/2 translate-x-12 p-2 rounded-full bg-blue-200 hover:bg-blue-300 transition-colors z-10"
