...
const PlacementSlider = () => {
  ...
  return (
    <div className="border shadow-md rounded-md shadow-blue-200 bg-slate-400 py-8 sm:py-14">
      <div className="flex-col mx-auto px-4 ">
        {/* Header */}
        <div className="space-y-4 pb-8 sm:pb-12">
          <p className="text-2xl sm:text-3xl font-semibold text-center bg-blue-400 block rounded-lg font-serif">
            Top Placements
          </p>
        ...
        <div className="relative ">
          ...
          {/* Placement Cards */}
          <div className="overflow-hidden  w-[sm] i   h-100 md:w-full lg:w-full ">
            <div
                  ...
                  <div
                    ...
                    <div className="grid place-items-center">
                      <img
                        src={placement.image}
                        alt={placement.name}
                        className="rounded-full w-40 4-20 border bg-blue-800 shadow-xl shadow-blue-500 hover:from rotate-6 to rotate-0 transparent "
                      />
                    </div>
