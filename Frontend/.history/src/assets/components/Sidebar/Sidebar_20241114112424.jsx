  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-6 right-1 z-50   bg-blue-500 rounded-md shadow-md  text-white  ">
        {isMobileOpen ? (
          <X className="w-6 h-6" />
        ) : (
      ...
      <div
        className={`
        fixed lg:static  right-100  z-40 rounded-md shadow-md shadow-inner p-0 mt-24 md:mt-0  text-white rounded shadow-md 
        transform ${
        ...
        overflow-y-auto
      `}>
        <nav className="flex flex-col h-full m-10">
          {/* Logo or Header Area 
