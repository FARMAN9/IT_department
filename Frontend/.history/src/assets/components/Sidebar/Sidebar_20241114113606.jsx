  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-7 right-3 z-50   bg-blue-500 rounded-md shadow-md  text-white  ">
        {isMobileOpen ? (
          <X className="w-6 h-6" />
        ) : (
      ...
      {isMobileOpen && (
        <div
          className="lg:hidden md:fixed inset-0  z-0"
      ...
      <div
        className={`
        fixed lg:static  right-100  z-40 rounded-md shadow-md shadow-inner p-0 mt-24 md:mt-0 lg:mt-6 mb-6 text-white rounded shadow-md 
        transform ${
