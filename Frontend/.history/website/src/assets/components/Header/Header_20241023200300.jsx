  ...
  return (
    <header className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded border-amber-950 font-sans">
      ...
      <div className="mobile-menu hidden md:hidden px-6 pb-4">
        ...
        <div className="relative group">
          <button onClick={() => toggleMenu(setPeopleMenuOpen)} className="block py-2 text-gray-200 flex items-center space-x-2 w-full text-left">
            <IoMdPeople />
            People
          </button>
          {peopleMenuOpen && (
        ...
        <div className="relative group">
          <button onClick={() => toggleMenu(setResearchMenuOpen)} className="block py-2 text-gray-200 flex items-center space-x-2 w-full text-left">
            <GiArchiveResearch />
            Research
          </button>
          {researchMenuOpen && (
        ...
        <div className="relative group">
          <button onClick={() => toggleMenu(setOutcomesMenuOpen)} className="block py-2 text-gray-200 flex items-center space-x-2 w-full text-left">
            <GiBrainstorm />
            Outcomes
          </button>
          {outcomesMenuOpen && (
