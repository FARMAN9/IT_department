          ...
          <div className=" mx-auto pt-4 space-y-8  bg-white">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start md:items-center mt-20 lg:mt-0">
              ...
              <div className="flex-grow">
                <h1 className="text-4xl font-bold text-gray-800 mb-2">{value.name}</h1>
                ...
                <div className="space-y-3">
                  <div className="flex gap-4">
                    ...
                    <a href={`mailto:${value.officeMail}`} className="text-gray-800 hover:text-emerald-600">
                      {value.officeMail}
                    </a>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <span className="text-gray-800">:</span>
                    <span className="text-gray-800">{value.phoneNumber} (O) </span>
                  </div>
                </div>
              </div>
            </div>
