...
const Mission = () => {
  ...
  const handleAddMission = async (e) => {
    ...
    try {
      ...
      await dispatch(fetchMissions()); // Refresh the list after adding
  ...
  // Delete mission handler (optional)
  ...
  // Memoized filtered missions based on search
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between items-center gap-4">
              <div className="w-full sm:w-96 relative">
                ...
                <div className="flex flex-col sm:flex-row  gap-2 mt-4">
                  <form onSubmit={handleAddMission} className="w-full sm:w-96">
                    <textarea
            ...
            {loading ? (
              ...
              <>
                ...
                {currentRows.map((mission) => (
                  <div key={mission._id} className="card  w-full shadow-xl">
