...
import {
  PostDepartmentsLabs,
  GetAllDepartmentsLabs,
  DeleteDepartmentsLabs,
  UpdateDepartmentsLabs,
  removeDepartmentsLabsImage,
  putLabManual,
  removeLabManual,
} from "../Controllers/DepartmentsLabs.controller.js";
...
router.put("/uploadLabManual/:id", handleUploadPDF, putLabManual);
